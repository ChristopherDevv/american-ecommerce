<script setup>
    import PrimaryLink from "@/components/primaries/PrimaryLink.vue";
</script>

<template>

<nav class="block sticky top-0 start-0 z-10 py-2 bg-white/60 backdrop-blur-md shadow-lg">
<!-- ========== HEADER ========== -->
  ...
  <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        <img alt="Vue logo" class="w-10 md:w-14" src="@/assets/secondary-logo.svg"/>
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
          <div class="flex flex-col divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end py-2 md:py-0 md:ps-7 md:divide-y-0 md:divide-solid">
            <a class="font-medium text-blue-600 py-3 md:px-3 md:py-6" href="#" aria-current="page">Landing</a>

            <a class="font-medium text-gray-500 hover:text-gray-400 py-3 md:px-3 md:py-6" href="#">
              Company
            </a>

            <div class="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] py-3 md:px-3 md:py-4">
            ...
            <div class="pt-3 md:pt-0">
                <primary-link to="admin" aria-label="Brand">Brand</primary-link>
            </div>
          </div>
        </div>
      </div>
